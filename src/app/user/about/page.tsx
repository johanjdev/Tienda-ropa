...
export default function AboutPage() {
  return (
    <main className="text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24"><div className="relative overflow-hidden rounded-3xl"><Image src="/imagenes/about/pant.jpg" alt="Streetwear CTA" width={1600} height={900} className="h-[400px] w-full object-cover" /><div className="absolute inset-0 bg-black/60" /><div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center"><h2 className="max-w-4xl text-4xl font-extrabold leading-tight md:text-6xl">Viste Tu Identidad.<br />Domina Las Calles.</h2><Link href="/user" className="mt-10 rounded-full bg-[#6b2ad4] px-8 py-4 font-semibold text-white transition hover:scale-110">Comprar Ahora</Link></div></div></section>
    </main>
  );
}
